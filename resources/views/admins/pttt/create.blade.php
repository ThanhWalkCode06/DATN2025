                        ...
                        <div class="tab-content " id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                <form method="post" class=" theme-form theme-form-2 mega-form"
                                    action="{{ route('phuongthucthanhtoans.store') }}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <input style="border: 1px solid #ced4da;"
                                                    class="form-control @error('ten_phuong_thuc') is-invalid @enderror"
                                                    type="text" name="ten_phuong_thuc"
                                                    value="{{ old('ten_phuong_thuc') }}">
