...
@section('content')
    <div class="container mt-4">
        ...
        <ul class="nav nav-tabs" id="settingsTabs">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#emailSettings"
                    onclick="saveTab('#emailSettings')">Cấu Hình Email</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#generalSettings" onclick="saveTab('#generalSettings')">Cấu
                    Hình Chung</a>
            </li>
        </ul>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name_website" class="form-control"
                                    value="{{ $globalSetting->name_website ?? 'Seven Stars' }}">
                                @error('name_website')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="location" class="form-control"
                                    value="{{ $globalSetting->location ?? 'Hà Nội' }}">
                                @error('location')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="phone" class="form-control"
                                    value="{{ $globalSetting->phone ?? '0387660612' }}">
                                @error('phone')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <img style="width:150px; height: 100px" class="img-fluid for-white"
