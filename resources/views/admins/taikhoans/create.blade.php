                                ...
                                <form method="post" class=" theme-form theme-form-2 mega-form"
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <input style="border: 1px solid #ced4da;"
                                                    ...
                                                    type="number" name="so_dien_thoai" value="{{ old('so_dien_thoai') }}">
                                                @error('so_dien_thoai')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <input style="border: 1px solid #ced4da;" class="form-control "
                                                    type="date" name="ngay_sinh" value="{{ old('ngay_sinh') }}">
                                                @error('ngay_sinh')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <input style="border: 1px solid #ced4da;"
                                                    class="form-control @error('dia_chi') is-invalid @enderror  @error('dia_chi') is-invalid @enderror"
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-lg-10 col-md-9 d-flex gap-3">
                                                <div class="form-check">
                                                    <input style="border: 1px solid #ced4da;" type="radio"
                                                        class="form-check-input" id="gioi_tinh_nam" name="gioi_tinh"
                                                        value="Nam" {{ old('gioi_tinh') == 'Nam' ? 'checked' : '' }}>
                                                    <label for="gioi_tinh_nam" class="form-check-label ms-1">Nam</label>
                                                </div>
                                                <div class="form-check">
                                                    <input style="border: 1px solid #ced4da;" type="radio"
                                                        class="form-check-input" id="gioi_tinh_nu" name="gioi_tinh"
                                                        value="Nữ" {{ old('gioi_tinh') == 'Nữ' ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <select name="role"
                                                    ...
                                                    name="state" data-select2-id="select2-data-1-vf8b" tabindex="-1"
                                                    aria-hidden="true" id="Select"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-9 col-lg-10">
                                                <input style="border: 1px solid #ced4da;"
                                                    class="form-control @error('password_verify') is-invalid @enderror"
