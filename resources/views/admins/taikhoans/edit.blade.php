                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-lg-10 col-md-9 d-flex gap-3">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="gioi_tinh_nam" name="gioi_tinh" value="Nam">
                                                    <label for="gioi_tinh_nam" class="form-check-label ms-1">Nam</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="gioi_tinh_nu" name="gioi_tinh" value="Nữ">
