                            ...
                            <form class="theme-form theme-form-2 mega-form" action="{{ route('phieugiamgias.update', $phieuGiamGia->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-md-9 col-lg-10">
                                            <input class="form-control @error('muc_giam_toi_da')  @enderror" type="number" name="muc_giam_toi_da" step="0.01" value="{{ old('muc_giam_toi_da',$phieuGiamGia->muc_giam_toi_da) }}">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-md-9 col-lg-10">
                                            <input class="form-control @error('muc_gia_toi_thieu')  @enderror" type="number" name="muc_gia_toi_thieu" step="0.01" value="{{ old('muc_gia_toi_thieu',$phieuGiamGia->muc_gia_toi_thieu) }}">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-md-9 col-lg-10">
                                            <input class="form-control @error('mo_ta') @enderror" type="text" name="mo_ta"  value="{{ old('mo_ta', $phieuGiamGia->mo_ta) }}">
                                            @error('mo_ta')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-lg-10 col-md-9 d-flex gap-3">
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" id="trang_thai_kich_hoat" name="trang_thai" value="1" {{ old('trang_thai', $phieuGiamGia->trang_thai) == 1 ? 'checked' : '' }}>
                                                <label for="trang_thai_kich_hoat" class="form-check-label ms-1">Kích hoạt</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="radio" class="form-check-input" id="trang_thai_khong_kich_hoat" name="trang_thai" value="0" {{ old('trang_thai', $phieuGiamGia->trang_thai) == 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="mt-4 d-flex gap-3">
                                        ...
                                        <button type="submit" class="btn btn-solid" id="update-button" disabled>Cập Nhật Mã Giảm Giá</button>
                                    </div>
                                </div>
                            </form>
