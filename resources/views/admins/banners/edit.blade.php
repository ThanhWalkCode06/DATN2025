                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                <form id="bannerForm" action="{{ route('bannerAdmin.update',$BannerItem->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="position" class="form-control ">
                                                    <option {{ $BannerItem->position == 'homepage' ? 'selected' : '' }}
                                                        value="homepage">Banner chính</option>
                                                    <option {{ $BannerItem->position == 'secondary' ? 'selected' : '' }}
                                                        value="secondary">Banner phụ</option>
                                                    <option {{ $BannerItem->position == 'sidebar' ? 'selected' : '' }}
                                                        value="sidebar">Banner sidebar</option>
                                                </select>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="number" name="do_uu_tien" class="form-control"
                                                    value="{{ $BannerItem->priority }}" id="numberInput">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="status" class="form-control js-example-basic-single w-100">
                                                    <option {{ $BannerItem->position == 1 ? 'selected' : '' }}
                                                        value="1">Hiển thị</option>
                                                    <option {{ $BannerItem->position == 0 ? 'selected' : '' }}
                                                        value="0">Ẩn</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="image-wrapper">
                                                @foreach ($BannerItem->bannerImgs as $index => $banner)
                                                    <div class="image-group position-relative mb-3">
                                                        <input type="hidden" name="require_image[{{ $index }}]"
                                                            value="1">
                                                        <button type="button"
                                                            class="btn-close position-absolute top-0 end-0 m-2 btn-remove-image"></button>

                                                        <div class="mb-2 image-container" data-index="{{ $index }}"
                                                            data-index="{{ $index }}">
                                                            <input type="file"
                                                            name="images[{{ $index }}]"
                                                            ...
                                                            data-index="{{ $index }}"
                                                            data-src="{{ url(Storage::url($banner->image_url)) ?? '' }}">
                                                        </div>
                                                        <div class="invalid-feedback d-none"></div>
                                                        {{-- <img src="{{ Storage::url($banner->image_url) }}" alt=""> --}}
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text" name="content[{{ $index }}]"
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text" name="descript[{{ $index }}]"
                                                                class="form-control" value="{{ $banner->descript }}">
                                                            <div class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="mb-2">
                                                            <select name="loai_lien_ket[{{ $index }}]"
                                                                class="form-control mb-2 loai-lien-ket">
                                                                <option value="">-- Loại liên kết --</option>
                                                                <option value="sanpham"
                                                                    {{ $banner->link_type == 'sanpham' ? 'selected' : '' }}>
                                                                    Sản phẩm</option>
                                                                <option value="danhmuc"
                                                                    {{ $banner->link_type == 'danhmuc' ? 'selected' : '' }}>
                                                                    Danh mục</option>
                                                                <option value="tuychinh"
                                                                    {{ $banner->link_type == 'tuychinh' ? 'selected' : '' }}>
                                                                    Tùy chỉnh</option>
                                                            </select>
                                                            <div class="invalid-feedback"></div>
                                                        </div>
                                                        ...
                                                        <div
                                                            class="select-sanpham {{ $banner->link_type == 'sanpham' ? '' : 'd-none' }} mb-2">
                                                            <select name="sanpham[{{ $index }}]"
                                                                class="form-control js-example-basic-single w-100">
                                                                <option value="">-- Chọn sản phẩm --</option>
                                                                @foreach ($listSanPham as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ $item->id == $banner->link_url ? 'selected' : '' }}>
                                                                        {{ $item->ten_san_pham }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div
                                                            class="select-danhmuc {{ $banner->link_type == 'danhmuc' ? '' : 'd-none' }} mb-2">
                                                            <select name="danhmuc[{{ $index }}]"
                                                                class="form-control js-example-basic-single w-100">
                                                                <option value="">-- Chọn danh mục --</option>
                                                                @foreach ($listDanhMucSP as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ $item->id == $banner->link_url ? 'selected' : '' }}>
                                                                        {{ $item->ten_danh_muc }}
                                                                    </option>
                                                        ...
                                                        <div
                                                            class="custom-url {{ $banner->loai_lien_ket == 'tuychinh' ? '' : 'd-none' }} mb-2">
                                                            <input type="text" name="custom_url[{{ $index }}]"
                                                                class="form-control" value="{{ $banner->link_url }}"
                                                                placeholder="Nhập URL tùy chỉnh">
                                                            <div class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="row mb-2">
                                                            <div class="col-md-6">
                                                                <label class="form-label-content_input">Nội dung
                                                                    button</label>
                                                                <input type="text"
                                                                    name="content_input[{{ $index }}]"
                                                                    class="form-control"
                                                                    value="{{ $banner->content_button }}">
                                                                <div class="invalid-feedback"></div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label class="form-label-trang_thai_button">Trạng thái
                                                                    button</label>
                                                                <select name="trang_thai_button[{{ $index }}]"
                                                                    class="form-control mb-2 js-example-basic-single w-100">
                                                                    <option value="1"
                                                                        {{ $banner->status_button == 1 ? 'selected' : '' }}>
                                                                        Hoạt động</option>
                                                                    <option value="0"
                                                                        {{ $banner->status_button == 0 ? 'selected' : '' }}>
...
@section('js')
    ...
    <script>
        ...
        function addImageInput() {
            ...
            const currentIndex = getNextImageIndex();
        ...
        function getNextImageIndex() {
            const inputs = document.querySelectorAll('#image-wrapper .image-file');
            const indices = Array.from(inputs).map(el => parseInt(el.dataset.index || "0"));
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function initFilePond() {
                document.querySelectorAll('.image-file').forEach(input => {
                    const dataSrc = input.getAttribute('data-src');
                    const pond = FilePond.create(input);
                    if (dataSrc) {
                        pond.addFile(dataSrc);
                    }
                });
            }
            // Sau khi render xong HTML input
            initFilePond();
