                                        ...
                                        <tr class="product-box-contain">
                                            <td class="product-detail">
                                                <div class="product border-0">
                                                    <a href="{{ route('sanphams.chitiet', $chiTietGioHang->bienThe->SanPham->id) }}"
                                                        class="product-image">
                                            ...
                                            <td class="price">
                                                ...
                                                <h5>
                                                    <span
                                                        class="gia-moi">{{ number_format($chiTietGioHang->bienThe->gia_ban, 0, '', '.') }}</span>đ
                                                    <del style="margin-left: 17px"
                                                        class="text-content">{{ number_format($chiTietGioHang->bienThe->sanPham->gia_cu, 0, '', '.') }}đ</del>
                                                </h5>
                                                <h6 style="margin-top: 10px" class="theme-color">Tiết kiệm :
                                                    {{ number_format($chiTietGioHang->bienThe->sanPham->gia_cu - $chiTietGioHang->bienThe->gia_ban, 0, '', '.') }}đ
                                                </h6>
                                            </td>
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input class="form-control input-number so-luong" type="number"
                                                                ...
                                                                onchange="showTong()" oninput="checkMaxQuantity(this)"
                                                                onchange="checkMaxQuantity(this)"
                                                                onkeypress="return isNumberKey(event)" min="1"
                                                                max="{{ $chiTietGioHang->bienThe->so_luong }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="save-remove">
                                                ...
                                                <button style="border: none;color: #2a2929; "
                                                    class="remove close-button close-button delete-cartIndex-item"
                                                    data-id="{{ $chiTietGioHang->id }}">
                ...
                <div class="col-xxl-3">
                    <div class="summery-box p-sticky">
                        ...
                        <div class="button-group cart-button">
                            <ul>
                                <li>
                                    <button id="btn-thanh-toan" class="btn btn-animation proceed-btn fw-bold">Thanh
                                        toán</button>
                                </li>
