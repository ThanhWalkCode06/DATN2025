        ...
        <div class="step">
            ...
            <div class="sub-step">
                ...
                <div class="sub-step">
                    ...
                    <img src="{{ asset('storage/images/huongdans/b7.2.2.png') }}" alt="Bước 7.2.2 - Quay lại website">
                </div>
            </div>
        </div>
    </div>
